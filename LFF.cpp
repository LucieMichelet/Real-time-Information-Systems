//////////////////////////////////////////////////////////////////////////
/////////////// TP n°2 : Implémentation des algorithmes - LFF ////////////
/////////////////////////// Lucie MICHELET ///////////////////////////////
...
float LFFused(int n,vector<task> vtask){
	float P;
	for(int i=0;i<n;i++){
...
void LFF_algorithm(int n, vector<task> vtask){
