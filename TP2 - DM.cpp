//////////////////////////////////////////////////////////////////////////
/////////////// TP n°2 : Implémentation des algorithmes - DM /////////////
/////////////////////////// Lucie MICHELET ///////////////////////////////
...
float DMused(int n,vector<task> vtask){
	float P;
	for(int i=0;i<n;i++){
...
void DM_algorithm(int n, vector<task> vtask){
